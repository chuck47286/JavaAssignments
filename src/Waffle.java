...
public class Waffle extends Application {
     ...
     */
    public static final Color[] colors =  {Color.BLACK, Color.BLUE,Color.RED,Color.YELLOW,Color.GREEN,Color.BROWN,Color.DARKBLUE,Color.SKYBLUE};
    /**
...
//    private static int maximum;
     ...
     */
    public static int[] calPercentage(Expenditure[] expenditures, int maximum) {
